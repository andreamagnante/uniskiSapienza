...
-- UserRegistrato_Coupon [rel20]
alter table `coupon`  add column  `userregistrato_oid_user`  integer;
alter table `coupon`   add index fk_coupon_userregistrato (`userregistrato_oid_user`), add constraint fk_coupon_userregistrato foreign key (`userregistrato_oid_user`) references `userregistrato` (`user_oid_user`);
