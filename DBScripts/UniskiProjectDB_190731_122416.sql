...
-- Portafoglio_UserRegistrato [rel6]
alter table `userregistrato`  add column  `portafoglio_oid`  integer;
alter table `userregistrato`   add index fk_userregistrato_portafoglio (`portafoglio_oid`), add constraint fk_userregistrato_portafoglio foreign key (`portafoglio_oid`) references `portafoglio` (`oid`);
